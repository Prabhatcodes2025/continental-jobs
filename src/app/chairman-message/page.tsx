...
export const metadata = {
  title: "Message from Chairman & Managing Director"
};
...
export default function ChairmanMessagePage() {
  return (
    <>
      <PageHero
        title="MESSAGE FROM CHAIRMAN & MANAGING DIRECTOR"
        text="A note on ethical recruitment, talent readiness, Human Resource Solutions and the responsibility of connecting families, employers and careers across borders."
        official
      />
      <section className="bg-white py-16">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
          <Image src="/brand/chairman-sajeevan.png" alt="Sajeevan Thumpayil Chairman and Managing Director" width={900} height={650} className="rounded-lg object-cover shadow-xl" />
          <article className="prose prose-slate max-w-none">
            ...
            <p>
              ...
              We aim to prepare candidates properly and support employers with reliable recruitment pipelines.
            </p>
            <p>
