...
export function PageHero({
  ...
  const titleLines = (official ? title.toUpperCase() : title).split("\n");
  ...
  return (
    <section className="premium-band text-white">
      <div className="mx-auto max-w-7xl px-4 py-20 lg:px-8 lg:py-24">
        ...
        <h1 className={`${eyebrow ? "mt-4" : ""} max-w-5xl ${titleSize} font-black leading-tight ${official ? "corporate-title-caps" : "corporate-title"}`}>
          {titleLines.map((line) => (
